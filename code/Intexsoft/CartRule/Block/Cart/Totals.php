...
namespace Intexsoft\CartRule\Block\Cart;

use Intexsoft\CartRule\Block\CartInfo;
use Intexsoft\CartRule\Helper\Data;
...
class Totals extends \Magento\Checkout\Block\Cart\AbstractCart
{
    ...
    public function setAttrCartValue(){
        $totals = $this->getTotals();
        $price = $totals['grand_total']->getValue();
        if($price != null)
            $this->dataCart->setAttributeData($price);
        else $this->dataCart->setAttributeData(0);
    }
}
